...
var rootCmd = &cobra.Command{
	Use:   "pmoves-crush",
	Short: "A PMOVES terminal-first AI assistant for software development",
	Long:  "A PMOVES-branded terminal-first AI assistant for software development and adjacent tasks",
	Example: `
# Run in interactive mode
pmoves-crush

# Run non-interactively
pmoves-crush run "Guess my 5 favorite Pokémon"

# Run a non-interactively with pipes and redirection
cat README.md | pmoves-crush run "make this more glamorous" > GLAMOROUS_README.md

# Run with debug logging in a specific directory
pmoves-crush --debug --cwd /path/to/project

# Run in yolo mode (auto-accept all permissions; use with care)
pmoves-crush --yolo

# Run with custom data directory
pmoves-crush --data-dir /path/to/custom/.crush

# Continue a previous session
pmoves-crush --session {session-id}

# Continue the most recent session
pmoves-crush --continue
  `,
