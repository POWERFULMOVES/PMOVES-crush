...
PMOVES-Crush is the [PMOVES.AI](https://github.com/POWERFULMOVES/PMOVES.AI)
integration fork of [Charmbracelet Crush](https://github.com/charmbracelet/crush).
It tracks the current upstream implementation while adding PMOVES service,
health, registry, release, and visual-ecosystem integration. See
[PMOVES.AI_INTEGRATION.md](PMOVES.AI_INTEGRATION.md) for the fork-specific
contract. The packaged command is `pmoves-crush`; upstream examples below that
use `crush` otherwise retain their original behavior.
